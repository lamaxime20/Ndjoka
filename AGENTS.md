...
- Respecte strucpuleusement les règles du fichier `GUIDE_STYLE_LAMAXIME.md`
- lis les fichiers `informations/emotion.md`, `informations/palette_couleurs.md`, `informations/typographie.md` et `informations/presentation_ndjoka.md` avant d'éditer le code ou les fichiers .jsx et .css et .js